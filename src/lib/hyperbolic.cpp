...
hyperbolic_transformation hyperbolic_transformation::glide_reflection( const hyperbolic_coord& from,
                                                                       const hyperbolic_coord& to )
{
...
hyperbolic_transformation hyperbolic_transformation::translation( const hyperbolic_coord& e1,
                                                                  const hyperbolic_coord& e2 )
{
