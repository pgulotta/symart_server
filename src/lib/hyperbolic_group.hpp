...
struct generator {
   ...
   * each generator.
   */
  generator( const hyperbolic_transformation& t, const hyperbolic_coord& e ) : trans( t ), edge( e ),
    is_flip( t.is_flip() ) {}
...
public:
  ...
  fundamental_domain_family( const std::initializer_list<side>& e ) : fundamental_domain_family( std::vector<side>
        ( e ) ) { }
